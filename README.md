...
* **Cumplimiento de objetivos del proyecto:** El objetivo principal de crear una plataforma que simplifique y optimice la gestión de espacios para eventos se cumplió mediante la combinación de funcionalidades web/móvil tradicionales con la capa de IoT diferenciadora. Los objetivos específicos alcanzados incluyen: (1) reducción del tiempo de verificación de disponibilidad de horas a segundos mediante calendario en tiempo real sincronizado con sensores, (2) eliminación de disputas sobre uso de espacios mediante registro objetivo de ocupación, (3) mejora en la satisfacción de propietarios al proporcionar visibilidad completa sobre sus activos, y (4) incremento en la confianza de arrendatarios al garantizar condiciones verificables del espacio.
